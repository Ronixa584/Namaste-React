    ...
    <div className="flex flex-wrap justify-start">
      ...
      <div className="flex flex-col">
        <div className="flex flex-row">
          <div className="shimmer-search-bar w-80 h-5 bg-gray-300 p-4 m-4 rounded-lg shadow-lg">
          ...
          <div className="shimmer-search-btn w-20 h-5 bg-gray-300 p-4 m-4 rounded-md shadow-lg">
            <div style={{ position: "relative", paddingBottom: "60%" }}>
