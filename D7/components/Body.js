...
const Body = () => {
  ...
  //[searchInput] dependancy array => once after initial render + everytime after render (i.e when text in search box changes)
  //[restaurants] dependancy array => it will not call at every rerender beacuse state of resturants will not change or not dependents
  useEffect(() => {
    //API call
    getRestaurants();
  ...
  async function getRestaurants(){
    ...
    console.log(json);
    //Optional Chaining i.e ?. .If data is not available then ? will handle error
    // setRestaurants(
